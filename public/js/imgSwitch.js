document.addEventListener("DOMContentLoaded", function() {
    ...
    heroSM.addEventListener('click', function() {
        ...
        side1SM.className = 'w-[30%] rounded border border-black opacity-50 transition-transform duration-200 hover:scale-[102%]';
    ...
    side1SM.addEventListener('click', function() {
        ...
        side1SM.className = 'w-[30%] rounded border border-black transition-transform duration-200 hover:scale-[102%]';
        side2SM.className = 'w-[20%] rounded border border-black opacity-50 transition-transform duration-200 hover:scale-[102%]';
